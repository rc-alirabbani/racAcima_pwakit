 ...
 * @returns {React.ReactElement} - Grid textWidthImage component.
 */
export const textWidthImage = ({regions}) => (
    <SimpleGrid className="textWidthImage" columns={1} gridGap={4} width={'100%'}>
        {regions.map((region) => (
...
textWidthImage.displayName = 'textWidthImage'

textWidthImage.propTypes = {
    // Internally Provided
